...
const game = {
  ...
  makeStep(question) {
    ...
    let nextTextAnswer = +prompt(questionText);
    nextTextAnswer = question.options[nextTextAnswer - 1].nextText;
    console.log(nextTextAnswer);
    return nextTextAnswer;

    //const nextQuestion_2 = this.question.find((q) => q.id === +questionText);
  },
